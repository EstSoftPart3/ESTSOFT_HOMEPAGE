    ...
    <div class="container-fluid hero-header bg-light ">
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <h1 class="display-4 mb-3 animated slideInDown"> <span class="menu" style="font-weight: 700;"><b>조직도</b></h1>
...
<!--                     <img class="img-fluid animated pulse infinite" style="animation-duration: 3s;border-radius: 5%;" src="/resources/fo/team/t14.jpg" alt=""> -->
					<img class="img-fluid animated pulse infinite" style="animation-duration: 3s;border-radius: 5%;" src="/resources/fo/img/est000.png">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container text-center">
          	...
          	<div class="row g-5 align-items-center">
          		...
          		<div class="col-lg-12 " style="border: 1px solid #cccccc;">
               		<img src="/resources/fo/img/orgin.png" >
           		</div>
