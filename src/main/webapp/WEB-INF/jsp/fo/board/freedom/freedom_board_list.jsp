...
<body>
    ...
    <div class="container-xxl py-5 menu">
		...
		<div class="row justify-content-center col-lg-5" style="padding-top:15px; margin: 0 auto;">
 	   	...
 	   	$.ajax({
	         ...
	         success: function(data) {
				...
				if(boardPager.curBlock > 1) {
					...
					ul.append(
					"<li class='page-item'><a class='page-link' href='javascript:freedomBoardList(1)'>&#60;&#60;</a></li>" +
					"<li class='page-item'><a class='page-link' href='javascript:freedomBoardList(" + boardPager.prevPage + ")'>&#60;</a></li>"
					);
				}
				...
				if(boardPager.curBlock <= boardPager.totBlock){
					ul.append(
					"<li class='page-item'><a class='page-link' href='javascript:freedomBoardList(" + boardPager.nextPage + ")'>&#62;</a></li>" +
					"<li class='page-item'><a class='page-link' href='javascript:freedomBoardList(" + boardPager.totPage + ")'>&#62;&#62;</a></li>"
					);
				}
