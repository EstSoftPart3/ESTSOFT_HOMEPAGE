...
<body>
    ...
    <div class="container-xxl py-5 menu">
        <div class="container">
            ...
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="display-3" style="font-size:20px;">기술문의 게시판 수정하기 </h1>
            </div>
         ...
         <div class="col-12 text-center" style="padding-top:15px;">
         	 ...
         	 <button type="button" class="btn btn-secondary btn-sm" onclick="technologyUpdate();">수정하기</button>
         </div>
    </div>
    <!-- FAQs Start -->
	...
	function technologyUpdate() {
	   ...
	   // 제목
		...
		$.ajax({
	           type: "post",
	           url: "/eep/board/technology/technologyBoardUpdateData.do",
	           data: {
	        	   brdSq : brdSq,
	        	   brdTtl : brdTtl,
	        	   brdCntnt : brdCntnt
