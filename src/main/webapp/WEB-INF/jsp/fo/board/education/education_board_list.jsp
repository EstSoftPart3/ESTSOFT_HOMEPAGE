 	   	...
 	   	$.ajax({
	         ...
	         success: function(data) {
				...
				if(boardPager.curBlock > 1) {
					...
					ul.append(
					"<li class='page-item'><a class='page-link' href='javascript:educationBoardList(1)'>[처음]</a></li>" +
					"<li class='page-item'><a class='page-link' href='javascript:educationBoardList(" + boardPager.prevPage + ")'>[이전]</a></li>"
					);
				}
				...
				if(boardPager.curBlock <= boardPager.totBlock){
					ul.append(
					"<li class='page-item'><a class='page-link' href='javascript:educationBoardList(" + boardPager.nextPage + ")'>[다음]</a></li>" +
					"<li class='page-item'><a class='page-link' href='javascript:educationBoardList(" + boardPager.totPage + ")'>[끝]</a></li>"
					);
				}
