...
<style>
	    		...
	    		<section class="content">
	    			...
	    			<div class="card-header p-2" style="border: 1px solid rgba(0,0,0,.125);background-color:#efefef">
	                 	<ul class="nav nav-pills">
		               		<li class="nav-item"><a class="sTitle" href="#" data-toggle="tab"><b>자유 게시판 수정 페이지</b></a></li>
		               	</ul>
					 </div>
								...
								<label class="col-form-label sTitle LabelStyle" style="text-align: center;">내용</label>
					 			...
					 			<div class="form-group row">
                    				...
                    				<div class="col-sm-4" style="text-align:right">
                    					...
                    					<button type="button" class="btn btn-info sTitle" onclick="freedomUpdate();">수정</button>
                    					<button type="button" class="btn btn-danger sTitle" onclick="freedomBoardDetail();">뒤로</button>
                    				</div>
   ...
   function freedomUpdate() {
	   ...
	   //잡지 제목
		...
		$.ajax({
	           type: "post",
	           url: "/admin/board/freedom/freedomBoardUpdateData.do",
	           data: {
	        	   brdSq : brdSq,
	        	   brdTtl : brdTtl,
	        	   brdCntnt : brdCntnt,
	           ...
	           success: function(data) {
	        	   bootbox.alert({
						 ...
						 locale: 'kr',
						 callback: function() {
							 	location.href='/admin/board/freedom/openFreedomBoardDetail.do?brdSq='+brdSq;
					     } });
			   },
	           error: function(error) {
	        	   var errorJson = JSON.stringify(error);
   ...
   function freedomBoardList() {
	   location.href='/admin/board/freedom/openFreedomeBoardList.do';
   }
