...
<script type="text/javascript">
    ...
    function getBoardDetailCallback(data){
        ...
        if(data != null){                                
            ...
            var boardReRef      = Detail.boardReRef; 
            var boardReLev      = Detail.boardReLev; 
            var boardReSeq      = Detail.boardReSeq; 
            var boardWriter     = Detail.boardWriter; 
            var boardSubject	= Detail.boardSubject; 
            var boardContent    = Detail.boardContent; 
            var boardHits       = Detail.boardHits;
            var delYn           = Detail.delYn; 
            var insUserId       = Detail.insUserId;
            var insDate         = Detail.insDate; 
