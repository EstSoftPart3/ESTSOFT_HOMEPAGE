		 ...
		 <div class="content-wrapper">
	    		...
	    		<section class="content">
					...
					<div class="card-header">
	                	<h3 class="card-title bTitle"><b>기술문의 게시판 목록</b></h3>
		                ...
		                <div class="card-tools">
		                  ...
		                  <div class="input-group input-group-sm" style="width: 800px;">
		                    ...
		                    <button type="button" class="btn btn-info sTitle" onclick="technologyBoardInsert();">게시판 작성</button>
		                  </div>
		                </div>
					 ...
					 <div class="form-group row" >
					 	...
					 	<div class="card-body" style="background-color:#ffffff;">
					 		<div class="col-sm-12">
					 			<div id="technologyBoardList" style="font-size:12px;"></div>
					 		</div>
					 	</div>
...
<script type="text/javascript">
        ...
        function technologyBoardInsert() {
     	   ...
     	   location.href = "/admin/board/technology/openTechnologyBoardInsert.do";
        }
     	   ...
     	   $("#technologyBoardList").jsGrid({
     	       ...
     	       controller: {
     	           loadData: function (filter) {
     	               ...
     	               $.ajax({
     	      	    	 type: "post",
     	    	    	 url: "/admin/board/technology/technologyBoardListData.do",
     	    	         data: params,
     	    	         dataType: "json"
     	    	      }).done(function(response) {
     	    	    	 //d.resolve(response.boardData.boardInfo);
     	    	    	 
     	    	    	 d.resolve($.map(response.technologyBoardData.technologyBoardInfo, function (item, itemIndex) {
                              
     	    	    		 var rSize = response.technologyBoardData.technologyBoardInfo.length - itemIndex;
        ...
        function fn_SubBrdPage(getData) {
     	   ...
     	   location.href='/admin/board/technology/openTechnologyBoardDetail.do?brdSq='+getData;
     	}
