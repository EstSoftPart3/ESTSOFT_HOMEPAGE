        ...
        function boardList(){
     	   ...
     	   $("#boardList").jsGrid({
     	       ...
     	       fields: [
     	    	   ...
     	    	   { name: "boardSeq", title: "글번호", type: "number", width: 30, align: "center", },
     	    	   { name: "boardSubject",title:"제목", type: "text", width: 200,align:"center",width:100 , visible: true},
     	    	   { name: "boardContent"	,title:"내용", type: "text", width: 150,align:"center" ,width:100, visible: true},
     	    	   { name: "boardWriter"	,title:"작성자", type: "text", width: 150,align:"center" ,width:100, visible: true}/* ,
