					...
					<div class="card-header">
		                ...
		                <div class="card-tools">
		                  ...
		                  <div class="input-group input-group-sm" style="width: 500px;">
		                    ...
		                    <input type="text" name="table_search" id="searchKeyword" class="form-control float-right bTitle" placeholder="검색어" style="width:350px;" >
...
<script type="text/javascript">
        ...
        function fn_SubBrdPage(getData) {
     	   ...
     	   location.href='/admin/board/boardDetail?brdSq='+getData;
     	}
