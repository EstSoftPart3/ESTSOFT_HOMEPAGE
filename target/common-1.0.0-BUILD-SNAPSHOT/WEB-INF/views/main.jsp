...
<head>
    ...
    <link href="/resources/fo/css/bootstrap.min.css" rel="stylesheet">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-4 py-lg-0"><!--active-->
    ...
    <div class="container-fluid hero-header bg-light py-5 mb-5">
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <h1 class="display-4 mb-3 animated slideInDown">THE BEST CHOICE</h1>
                </div>
                <div class="col-lg-6 animated fadeIn">
                    <img class="img-fluid animated pulse infinite" style="animation-duration: 3s;border-radius: 5%;" src="/resources/fo/img/main_01.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-white p-5">
                        <img class="img-fluid mb-4" src="/resources/fo/img/icon-7.png" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white p-5">
                        <img class="img-fluid mb-4" src="/resources/fo/img/icon-3.png" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-white p-5">
                        <img class="img-fluid mb-4" src="/resources/fo/img/icon-9.png" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item bg-white p-5">
                        <img class="img-fluid mb-4" src="/resources/fo/img/icon-5.png" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item bg-white p-5">
                        <img class="img-fluid mb-4" src="/resources/fo/img/icon-2.png" alt="">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item bg-white p-5">
                        <img class="img-fluid mb-4" src="/resources/fo/img/icon-8.png" alt="">
        ...
        <div class="container py-5">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 text-center">
                    <img class="img-fluid m-1" src="/resources/fo/img/payment-1.png" alt="" style="width: 50px;">
                    <img class="img-fluid m-1" src="/resources/fo/img/payment-2.png" alt="" style="width: 50px;">
                    <img class="img-fluid m-1" src="/resources/fo/img/payment-3.png" alt="" style="width: 50px;">
                    <img class="img-fluid m-1" src="/resources/fo/img/payment-4.png" alt="" style="width: 50px;">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid bg-light footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-md-6">
                    <h1 class="text-primary mb-4"><img class="/resources/fo/img-fluid me-2" src="/resources/fo/img/icon-1.png" alt=""
